/**
 * Free-text location → coordinates (frontend only — no backend required).
 *
 * 1) Local Kenya aliases (instant)
 * 2) Mapbox Geocoding when VITE_MAPBOX_ACCESS_TOKEN is set
