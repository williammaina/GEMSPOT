      ...
      <nav className={styles.NavbarContainer} aria-label="Primary">
        <Link to="/" className={styles.BrandMark} aria-label="GemSpot KE home">
          <span className={styles.BrandIconShell} aria-hidden="true">
            <GemSpotLogo size={28} className={styles.LogoIcon} />
          </span>
        ...
        <div className={styles.NavActions}>
          ...
          <Link
            to="/saved"
            className={styles.IconButton}
            aria-label={favCount ? `${favCount} saved places` : 'Saved places'}
          >
            <Heart size={16} />
            {favCount > 0 && (
          ...
          <Link to="/plan" className={styles.IconLink} title="Your plan" aria-label="Your plan">
            <ClipboardList size={18} />
            {planCount > 0 && <span className={styles.Badge}>{planCount}</span>}
          </Link>
              ...
              <div className={styles.ProfileMenu} role="menu">
                {signedIn ? (
                  <>
                    ...
                    <Link to="/plan" role="menuitem" onClick={() => setProfileOpen(false)}>
                      <ClipboardList size={15} /> Your plan
                    </Link>
                    {isAdmin && (
