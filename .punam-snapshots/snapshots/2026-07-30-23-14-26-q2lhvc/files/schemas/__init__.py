...
from schemas.category_schema import CategorySchema, TagSchema, category_schema, categories_schema, tag_schema, tags_schema
...
from schemas.event_schema import EventSchema, EventBookmarkSchema, event_schema, events_schema, event_bookmark_schema, event_bookmarks_schema
...
__all__ = [
    ...
    'EventSchema', 'EventBookmarkSchema', 'event_schema', 'events_schema', 'event_bookmark_schema', 'event_bookmarks_schema',
